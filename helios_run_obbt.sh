...
python ~/CRL_experiments/runner.py \
       	...
       	--experiment_name sokoban_obbt_bs512_dot_symloss \
	--gin_bindings \
	"run.seed=$SLURM_JOB_ID" \
	"run.wandb=True" \
	"LNConvNet.dropout_p=0.0" \
	"TrainJobOBBT.mbbt=False" \
	"TrainJobOBBT.metric='dot'" \
	"TrainJobOBBT.tau=0.0" \
	"TrainJobOBBT.batch_size=512" \
	"TrainJobOBBT.test_interval=20000" \
	"TrainJobOBBT.train_steps=100000"
